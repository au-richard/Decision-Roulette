...
const SavedCategory = (props) => {
  ...
  return (
    <>
      <p>
        <font color="azure">Category: </font>
        <font color="limegreen">{ctx.myinput[6]}</font>
      </p>
